...
protocol WTViewControllerDelegate: class {
  func walkthroughViewControllerDidFinishFlow(_ vc: WTViewController)
}

class WTViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
  @IBOutlet var pageControl: UIPageControl!
  
  weak var delegate: WTViewControllerDelegate?
